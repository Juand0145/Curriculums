...
\cvsection{Trayectoria Comercial}
\begin{center}
\begin{tikzpicture}
\begin{axis}[
    ybar,
...
\legend{B2B, Prospección, CRM, Cierre, Dificultades, Pruebas}
\end{axis}
\end{tikzpicture}
\end{center}
...
\cvsection{Negociación con Cliente}
...
\vspace{0.3cm}
{\small\justifying
\textbf{\color{accent}Conocimiento del negocio}\\
Tiempos de ejecución, procesos internos, estado de compra y productos utilizados.\\[4pt]
\textbf{\color{accent}Conocimiento del personal}\\
Roles clave, responsables y tomadores de decisión.\\[4pt]
\textbf{\color{accent}Análisis de la competencia}\\
Principales competidores, precios de compra y propuestas de valor.\\[4pt]
\textbf{\color{accent}Estado de la negociación}\\
Precios vigentes, condiciones comerciales y relación con competidores.\\[4pt]
\textbf{\color{accent}Propuesta comercial preparada}\\
Información técnica, estructura de precios, argumentos de valor y condiciones listas para presentar.\par
}
