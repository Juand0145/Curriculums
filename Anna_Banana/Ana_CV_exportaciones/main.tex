...
\name{Ana María \newline Albarracín Noreña}
  \tagline{Ejecutiva Comercial Sr B2B}
...
\cvsection{Perfil}
{\small\justifying
Profesional con sólida formación técnica y enfoque estratégico en ventas consultivas para mercados internacionales. Integro conocimiento técnico especializado con habilidades comerciales para estructurar soluciones de alto valor, asesorar clientes industriales y liderar procesos de negociación orientados al cierre efectivo de negocios.

Cuento con experiencia en negociación B2B, soporte técnico especializado y desarrollo de mercado en los sectores de energías renovables y productos químicos especializados (poliuretano). He gestionado ciclos completos de venta, desde la prospección y estructuración de ofertas técnicas hasta el cierre y seguimiento postventa.

Poseo amplia experiencia en comercio internacional, incluyendo planificación de forecast, gestión presupuestal, administración de inventarios, negociación y desarrollo de proveedores, así como coordinación logística y operaciones de exportación. Conocimiento avanzado en procesos aduaneros, documentación de comercio exterior y gestión ante la DIAN, asegurando cumplimiento normativo y eficiencia operativa en transacciones internacionales.
\par}
...
\begin{polaraxis}[
    ...
    xticklabels={B2B, Prosp., CRM, Cierre, Reclamos, Pruebas},
